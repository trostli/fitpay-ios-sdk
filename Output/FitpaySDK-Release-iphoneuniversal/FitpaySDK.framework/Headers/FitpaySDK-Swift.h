...
- (void)update:(NSString * _Nullable)firmwareRevision softwareRevision:(NSString * _Nullable)softwareRevision notifcationToken:(NSString * _Nullable)notifcationToken completion:(void (^ _Nonnull)(DeviceInfo * _Nullable device, NSError * _Nullable error))completion;
